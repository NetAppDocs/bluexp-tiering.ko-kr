...
+
** 포트 443을 통해 Cloud Tiering 서비스 및 Google Cloud Storage에 HTTPS로 연결합니다 (https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-set-up-networking-google.html#endpoints-contacted-for-day-to-day-operations["끝점 목록을 참조하십시오"^])
